...
import styles from './Gene_classification.module.css';
import Sidebar from '../Sidebar/Sidebar';
import axios from 'axios';

const Gene_classification = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        setIsLoading(true);
        const response = await axios.get(`${import.meta.env.VITE_ML_FASTAPI_URL}/categories/gene_bin_classification_best`);
        ...
        initialInputs['Year'] = 2024; // Set the default value for 'Year' column
  ...
  return (
    <div className={styles.dashboardContainer}>
      ...
      <main className={styles.mainContent}>
        <h2 className={styles.mainHeading}>Gene Classification</h2>
...
export default Gene_classification;